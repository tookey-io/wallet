...
class NativeImpl extends FlutterRustBridgeBase<NativeWire> implements Native {
            factory NativeImpl(ffi.DynamicLibrary dylib) => NativeImpl.raw(NativeWire(dylib));

            NativeImpl.raw(NativeWire inner) : super(inner);

            Future<String> toPublicKey({ required String key,required bool compressed,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_to_public_key(port_, _api2wire_String(key), compressed),
...
Future<String> toEthereumAddress({ required String key,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_to_ethereum_address(port_, _api2wire_String(key)),
            parseSuccessData: _wire2api_String,
...
Future<String> messageToHash({ required String message,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_message_to_hash(port_, _api2wire_String(message)),
            parseSuccessData: _wire2api_String,
...
Future<String> toEthereumSignature({ required String message,required String signature,required int chain,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_to_ethereum_signature(port_, _api2wire_String(message), _api2wire_String(signature), _api2wire_u32(chain)),
            parseSuccessData: _wire2api_String,
...
Stream<String> connectLogger({ dynamic hint }) => executeStream(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_connect_logger(port_),
            parseSuccessData: _wire2api_String,
...
Future<int> getNextId({ dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_get_next_id(port_),
...
Stream<OutgoingMessage> initialize({ required int id,dynamic hint }) => executeStream(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_initialize(port_, _api2wire_u32(id)),
...
Future<void> receive({ required int id,required IncomingMessage value,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_receive(port_, _api2wire_u32(id), _api2wire_box_autoadd_incoming_message(value)),
...
Future<OutgoingMessage> criticalStaticMethodOutgoingMessage({ required String message,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_critical__static_method__OutgoingMessage(port_, _api2wire_String(message)),
            parseSuccessData: _wire2api_outgoing_message,
...
Future<OutgoingMessage> invalidStaticMethodOutgoingMessage({ required String message,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_invalid__static_method__OutgoingMessage(port_, _api2wire_String(message)),
            parseSuccessData: _wire2api_outgoing_message,
