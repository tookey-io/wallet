...
Future<String> toPublicKey({ required String key,required bool compressed,dynamic hint }) => _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_to_public_key(port_, _platform.api2wire_String(key), compressed),
        ...
        FlutterRustBridgeTaskConstMeta get kToPublicKeyConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "to_public_key",
            argNames: ["key", "compressed"],
        );
        
Future<String> toEthereumAddress({ required String key,dynamic hint }) => _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_to_ethereum_address(port_, _platform.api2wire_String(key)),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kToEthereumAddressConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "to_ethereum_address",
            argNames: ["key"],
        );
        
Future<String> messageToHash({ required String message,dynamic hint }) => _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_message_to_hash(port_, _platform.api2wire_String(message)),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kMessageToHashConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "message_to_hash",
            argNames: ["message"],
        );
        
Future<String> toEthereumSignature({ required String message,required String signature,required int chain,dynamic hint }) => _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_to_ethereum_signature(port_, _platform.api2wire_String(message), _platform.api2wire_String(signature), api2wire_u32(chain)),
            parseSuccessData: _wire2api_String,
        ...
        FlutterRustBridgeTaskConstMeta get kToEthereumSignatureConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "to_ethereum_signature",
            argNames: ["message", "signature", "chain"],
        );
        
Stream<String> connectLogger({ dynamic hint }) => _platform.executeStream(FlutterRustBridgeTask(
        ...
        FlutterRustBridgeTaskConstMeta get kConnectLoggerConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "connect_logger",
            argNames: [],
        );
        
Future<int> getNextId({ dynamic hint }) => _platform.executeNormal(FlutterRustBridgeTask(
        ...
        FlutterRustBridgeTaskConstMeta get kGetNextIdConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "get_next_id",
            argNames: [],
        );
        
Stream<OutgoingMessage> initialize({ required int id,dynamic hint }) => _platform.executeStream(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_initialize(port_, api2wire_u32(id)),
...
Future<void> receive({ required int id,required IncomingMessage value,dynamic hint }) => _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_receive(port_, api2wire_u32(id), _platform.api2wire_box_autoadd_incoming_message(value)),
        ...
        FlutterRustBridgeTaskConstMeta get kReceiveConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "receive",
            argNames: ["id", "value"],
        );
        
Future<OutgoingMessage> criticalStaticMethodOutgoingMessage({ required String message,dynamic hint }) => _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_critical__static_method__OutgoingMessage(port_, _platform.api2wire_String(message)),
            parseSuccessData: _wire2api_outgoing_message,
...
Future<OutgoingMessage> invalidStaticMethodOutgoingMessage({ required String message,dynamic hint }) => _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_invalid__static_method__OutgoingMessage(port_, _platform.api2wire_String(message)),
            parseSuccessData: _wire2api_outgoing_message,
...
@protected
                    ffi.Pointer<wire_IncomingMessage> api2wire_box_autoadd_incoming_message(IncomingMessage raw) {
                        final ptr = inner.new_box_autoadd_incoming_message_0();
                        _api_fill_to_wire_incoming_message(raw, ptr.ref);
                        return ptr;
                    }
@protected
                    ffi.Pointer<wire_TookeyScenarios> api2wire_box_autoadd_tookey_scenarios(TookeyScenarios raw) {
...
void _api_fill_to_wire_incoming_message(IncomingMessage apiObj, wire_IncomingMessage wireObj) {
                if (apiObj is IncomingMessage_Begin) {
                                ...
                                wireObj.kind.ref.Begin.ref.scenario = api2wire_box_autoadd_tookey_scenarios(apiObj.scenario);
                                return;
                            }
...
wireObj.kind.ref.Participant.ref.party = api2wire_opt_box_autoadd_u16(apiObj.party);
                                return;
                            }
if (apiObj is IncomingMessage_Group) {
                                wireObj.tag = 2;
                                wireObj.kind = inner.inflate_IncomingMessage_Group();
                                wireObj.kind.ref.Group.ref.indexes = api2wire_uint_16_list(apiObj.indexes);
wireObj.kind.ref.Group.ref.parties = api2wire_uint_16_list(apiObj.parties);
                                return;
                            }
if (apiObj is IncomingMessage_Communication) {
                                wireObj.tag = 3;
                                wireObj.kind = inner.inflate_IncomingMessage_Communication();
                                wireObj.kind.ref.Communication.ref.packet = api2wire_String(apiObj.packet);
                                return;
                            }
...
wireObj.kind.ref.KeygenECDSA.ref.threashold = api2wire_u16(apiObj.threashold);
                                return;
                            }
if (apiObj is TookeyScenarios_SignECDSA) {
                                wireObj.tag = 1;
                                wireObj.kind = inner.inflate_TookeyScenarios_SignECDSA();
                                wireObj.kind.ref.SignECDSA.ref.parties = api2wire_uint_16_list(apiObj.parties);
